  ...
  //  ui->tableView->setModel(tmpemployee.afficher_employe());
    ...
    ui->comboBox_id->setModel(tmpemployee.afficher_employe());
     ui->lineEdit_5->setValidator(new QIntValidator(0000,9999,this));
      ...
      QPixmap pix("C:/Users/oumayma/Desktop/test/1.jpg");

      ui->label_pic->setPixmap(pix.scaled(1241,751,Qt::KeepAspectRatio));
      ui->label_9->setPixmap(pix.scaled(1241,751,Qt::KeepAspectRatio));
