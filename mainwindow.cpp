...
void MainWindow::on_tableView_facture_doubleClicked(const QModelIndex &index)
{
...
void MainWindow::on_tableView_recette_clicked(const QModelIndex &index)
{
...
void MainWindow::on_tableView_recette_doubleClicked(const QModelIndex &index)
{
    Modifier ac(this);
...
void MainWindow::on_recherche_2_textChanged(const QString &arg2)
{
...
{
    Smtp* smtp = new Smtp("dhakerbadri.bbt@gmail.com",ui->mail_pass_2->text(), "smtp.gmail.com");
    connect(smtp, SIGNAL(status(QString)), this, SLOT(mailSent(QString)));

    if( !files.isEmpty() )
        smtp->sendMail("dhakerbadri.bbt@gmail.com", ui->rcpt_2->text() , ui->subject_2->text(),ui->msg_2->toPlainText(), files );
    else
        smtp->sendMail("dhakerbadri.bbt@gmail.com", ui->rcpt_2->text() , ui->subject_2->text(),ui->msg_2->toPlainText());
}
